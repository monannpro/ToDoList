...
export const filterBtns = document.querySelectorAll(".categories button")
export const title = document.querySelector(".title");
export const expiredDiv = document.querySelector("#expired-div");
export const expiredCheckbox = document.querySelector("#expired-checkbox");
